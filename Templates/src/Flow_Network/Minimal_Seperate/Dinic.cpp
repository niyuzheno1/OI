...
namespace Minimal_Seperate_Dinic
{
	/*	ToDo:
	 *	@constants : modify here to adjust the maxium of answer.
	 */
...
bool Minimal_Seperate_Dinic::dinic_dfs (const long position , long * delta)
{
	set [position] = 1;
...
bool Minimal_Seperate_Dinic::dinic_bfs ()
{
...
long Minimal_Seperate_Dinic::dinic ()
{
	long Return = 0;
